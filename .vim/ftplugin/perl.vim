...
if !exists("g:Perl_NoKeyMappings") || ( exists("g:Perl_NoKeyMappings") && g:Perl_NoKeyMappings!=1 )
	...
	nnoremap    <buffer>  <silent>  <Leader>sfe             :call Perl_StatBlock( "a", "foreach (){\n}", "" )<CR>$<left><left>a
	nnoremap    <buffer>  <silent>  <Leader>si              :call Perl_StatBlock( "a", "if (){\n}", "" )<CR>f(a
	nnoremap    <buffer>  <silent>  <Leader>sie             :call Perl_StatBlock( "a", "if (){\n}else{\n}", "" )<CR>f(a
	nnoremap    <buffer>  <silent>  <Leader>siei            :call Perl_StatBlock( "a", "if (){\n}elsif (){\n}else{\n}", "" )<CR>f(a
	...
	nnoremap    <buffer>  <silent>  <Leader>sub             :call Perl_StatBlock( "a", "sub \n{\nmy ($self, $args) = @_;\n\n}\n\n", "")<CR>)A
	...
	vnoremap    <buffer>  <silent>  <Leader>sfe   <C-C>:call Perl_StatBlock( "v", "foreach (){", "}" )<CR>$<left><left>a
	vnoremap    <buffer>  <silent>  <Leader>si    <C-C>:call Perl_StatBlock( "v", "if (){", "}" )<CR>f(l<left>a
	vnoremap    <buffer>  <silent>  <Leader>sie   <C-C>:call Perl_StatBlock( "v", "if (){", "}else{\n}" )<CR>f(l<left>a
	vnoremap    <buffer>  <silent>  <Leader>siei  <C-C>:call Perl_StatBlock( "v", "if (){", "}elsif (){\n}else{\n}" )<CR>f(l<left>a
	...
	vnoremap    <buffer>  <silent>  <Leader>sub   <C-C>:call Perl_StatBlock( "v", "sub \n{\nmy ($self, $args) = @_;\n\n", "}\n\n")<CR>))A
	...
	inoremap    <buffer>  <silent>  <Leader>sfe   <C-C>:call Perl_StatBlock( "a", "foreach (){\n}", "" )<CR>$<left><left>a
	...
	inoremap    <buffer>  <silent>  <Leader>siei  <C-C>:call Perl_StatBlock( "a", "if (){\n}elsif (){\n}else{\n}", "" )<CR>f(l<left>a
	...
	inoremap    <buffer>  <silent>  <Leader>sub   <C-C>:call Perl_StatBlock( "a", "sub \n{\nmy ($self, $args) = @_;\n\n}\n\n", "")<CR>)A
	"
